      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 relative bg-white rounded-xl shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] p-8 lg:p-10 overflow-hidden">
          ...
          <div className="relative flex items-center gap-4 py-2 mb-4">
            ...
            <span className="text-xs tracking-wide uppercase text-[#777587]">
              Or complete profile
            </span>
            <span className="flex-1 h-px bg-[#e2e7ff]" />
          </div>
          ...
          {/* Error */}
          {error && (
            <p className="relative mb-4 text-sm text-red-600 bg-red-50 p-2 rounded-lg">
              {error}
            </p>
          )}
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label
                  htmlFor="fullName"
                  className="text-xs font-medium tracking-wide uppercase text-[#464555]"
                >
                  Full Name
                </label>
          ...
          <div className="bg-white rounded-xl shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] p-6 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-[#777587] ml-2">
                  INV-2024-0089
                </span>
              </div>
            ...
            <div className="bg-[#f2f3ff] rounded-lg p-4 flex flex-col gap-3">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-xs font-medium tracking-wide uppercase text-[#777587]">
                    Billed To
                  </p>
            ...
            {[
              {
                ...
                body: 'Send as many PDF or web invoices as you need with 0 limits.',
              },
              {
                bg: 'bg-[#e2dfff]',
                icon: '⏰',
                title: 'Automated reminders',
                body: 'Intelligent recurring chasers that recover debts 3x faster.',
              },
              {
                bg: 'bg-[#ffddb8]',
                icon: '💳',
                title: 'Stripe & PayPal integration',
                body: 'Instant 1-click checkout with cards, Apple Pay, SEPA, and wire.',
              },
            ].map((item) => (
              <div
                key={item.title}
                className="bg-white rounded-xl shadow-sm p-4 flex items-center gap-3.5"
              >
                <div
                  className={`size-10 rounded-lg flex items-center justify-center text-lg shrink-0 ${item.bg}`}
                >
                  {item.icon}
                </div>
